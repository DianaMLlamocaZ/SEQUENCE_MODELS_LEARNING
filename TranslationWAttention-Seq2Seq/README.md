# Notebook
Si quieres ver el notebook, click [¡aquí!](./TranslationSeq2SeqWAttention.ipynb) :)
...
- **Decoder:**
  ...
  - **Attention mechanism:**
    ...
    - Posteriormente, se multiplica el resultado anterior con la matriz 'Va' y aplico la *softmax function* para normalizar los *scores* a un rango de [0,1], formando así una distribución de probabilidad, que representan, finalmente, los *weight scores*.
